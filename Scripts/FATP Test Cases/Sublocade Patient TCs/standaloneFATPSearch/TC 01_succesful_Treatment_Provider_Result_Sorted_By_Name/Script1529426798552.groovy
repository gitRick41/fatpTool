...
//zipcode 10250, 
WebUI.setText(findTestObject('sublocadePatientOR/Page_Home/HP_FatpSearch/TopSection/input_ZipCode'), '23456')
...
WebUI.click(findTestObject('sublocadePatientOR/Page_FATP_SearchResults/a_filter_item_active_city'))

WebUI.verifyElementText(findTestObject('sublocadePatientOR/Page_FATP_SearchResults/txt_resultProvidersCounter'), '55')

WebUI.verifyElementText(findTestObject('sublocadePatientOR/Page_FATP_SearchResults/a_filter_item_active_city'), "City")
