...
WebUI.setText(findTestObject('sublocadePatientOR/Page_Home/HP_FatpSearch/TopSection/input_ZipCode'), '10250')
...
WebUI.verifyElementText(findTestObject('sublocadePatientOR/Page_FATP_SearchResults/txt_ZipcodeNotFoundErrorMessage'), 'The ZIP code entered cannot be found. The search results for the state you are searching within are as follows.')
